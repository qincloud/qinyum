...
public class QinLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
	 ...
	 *            absolute URL.
	 */
	public QinLoginUrlAuthenticationEntryPoint(String loginFormUrl) {
